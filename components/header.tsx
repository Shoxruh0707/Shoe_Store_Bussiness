...
export default function Header() {
  ...
  const categories = [
    ...
    { name: 'Winter', href: '/products?category=winter' },
    { name: 'Summer', href: '/products?category=summer' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button className="hidden sm:block text-primary-foreground hover:text-accent transition-colors">

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/products?category=sneakers" className="hover:text-accent transition-colors">
                  Sneakers
                </Link>
              </li>
              <li>
                <Link href="/products?category=casual" className="hover:text-accent transition-colors">
                  Casual
                </Link>
              </li>
              <li>
                <Link href="/products?category=winter" className="hover:text-accent transition-colors">
                  Winter
                </Link>
              </li>
              <li>
                <Link href="/products?category=summer" className="hover:text-accent transition-colors">
                  Summer
                </Link>
              </li>
              <li>
                <Link href="/products?category=kids" className="hover:text-accent transition-colors">
                  Kids
                </Link>
              </li>
            </ul>
